...
\section{Select Publications}
  \resumeSubHeadingListStart
    \resumeSubItem{}{Zhang, Y. (co-lead); Fraggedakis, D. (co-lead); Gao, T. (co-lead); Pathak, S. (co-lead) et al. "Lithium-ion intercalation by coupled ion-electron transfer", Science (2025), DOI:10.1126/science.adq2541}

    \resumeSubItem{}{Ipers, G. (co-lead); Jiao, J. (co-lead); Pathak, S. (co-lead); et al. "Rapid Simulation of Electro-Chemo-Mechanical Deformation of Li-ion Batteries", Nano Letters (2024), DOI:10.1149/1945-7111/ad4f1e}
    ...
    \resumeSubItem{}{Ombrini, P.; Pathak, S.; et al. "Modeling Single-Crystal Electrodes as Network of Primary Particles", Energy Environ. Sci., Under Review}
...
\section{Awards and Achievements}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{MIT 100K Competition: }{Top 13 finalist pitches at MIT 100K Accelerate 2024}

    \resumeSubItem{Research Fellowships: }{DAAD WISE Scholarship (2019), Max Planck Institute fellowship (2020), Mitacs fellowship with 4000+ CAD support}

    \resumeSubItem{Competitive Exams: }{Top 1.659\% (155K candidates) JEE Advanced 2016; Rank 37 (127K candidates) WBJEE 2016}

    \resumeSubItem{Press: }{Featured in MIT News, Quantum Zeitgeist, Azom for battery modeling research}
  \resumeSubHeadingListEnd
